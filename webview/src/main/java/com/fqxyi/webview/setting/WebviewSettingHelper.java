...
public class WebviewSettingHelper {
    ...
    public void initWebview(BaseWebview webView, WebviewBinderHelper binderHelper,
        ...
        webView.setWebChromeClient(new CustomWebChromeClient(activity, webChromeClientCallback));
        webView.setWebViewClient(new CustomWebviewClient(activity, webviewClientCallback));
    }
    ...
    private void initWebviewSetting(WebView webView) {
        ...
        webSettings.setAppCachePath(context.getDir("appcache", Context.MODE_PRIVATE).getPath());
        //允许WebView使用File协议
